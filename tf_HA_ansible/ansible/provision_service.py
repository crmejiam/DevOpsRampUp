...
def instance_provision(server_type):
    ...
    os.system('ssh-copy-id -f -i /home/ubuntu/.ssh/id_rsa.pub -o "IdentityFile /home/ubuntu/{}" ubuntu@{}'.format("Ramp-Up-cristian.mejiam-Key-Pair.pem", request.args.get("ip")))
